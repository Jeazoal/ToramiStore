...
public class EmailServiceImpl {
    ...
    public void sendVerificationEmail(String to, String token) {
        ...
        String verificationUrl = "http://localhost:8080/toramistore/account/verify?token=" + token; // Cambia esto si usas un dominio real
    ...
    public void sendEmail(String to, String subject, String content, boolean isHtml) {
        try {
            ...
            helper.setText(content, isHtml); // Habilita HTML si 'isHtml' es true
